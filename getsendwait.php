<?php
    ...
    $query = "SELECT * FROM vanbandi, phongban , loaivanban, mucdo where trangthai = 'chưa gửi' and vanbandi.idPhongBan='$idRoom' and phongban.idphongban= vanbandi.idnoinhan 
