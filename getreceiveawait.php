<?php
    ...
    $query = "SELECT * FROM loaivanban, mucdo, vanbannhan, phongban where trangthai = 'chưa duyệt' and vanbannhan.idPhongBan='$idRoom' and phongban.idphongban= vanbannhan.idnoiden and vanbannhan.idLoaiVanBan = loaivanban.idLVB and vanbannhan.idMucDo = mucdo.idMucDo";
